...
async function startBot() {
    ...
    // --- INJECTED: ADVANCED GROUP EVENTS (STATS/WELCOME) ---
    ...
    sock.ev.on('messages.upsert', async ({ messages }) => {
        ...
        // --- INJECTED: ANTI-DELETE & VIEWONCE (DM OWNER) ---
        ...
        if (from === 'status@broadcast') {
            ...
            const moodPrompt = `React as a cool human friend to this status in any language: "${body}". Be brief and natural. No quotes.`;
        ...
        // --- INJECTED: UNIVERSAL AUTO-AI CHAT (NATURAL) ---
